namespace trturino.GerenciadorGames.WebApps.WebMVC.Infrastructure
{
    public static class API
    {
        public static class Amigo
        {
            ...
            public static string DeleteAmigo(string baseUri, int id) => $"{baseUri}/{id}";
        }
        ...
        public static class Emprestimo
        {
            ...
            public static string DeleteEmprestimo(string baseUri, int id) => $"{baseUri}/{id}";
        }
        ...
        public static class Game
        {
            ...
            public static string DeleteGame(string baseUri, int id) => $"{baseUri}/{id}";
        }
    }
}